...
<div class="container">
    ...
    <h1 style="text-align: center; margin-top:30px;">Interest Details</h1>

    <a href="{{action('InterestController@create')}}" class="btn btn-primary a-btn-slide-text">

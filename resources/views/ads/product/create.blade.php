...
<div class="container">
    ...
    <div class="jumbotron">
        ...
        <form  method="POST" action="{{route('product.store')}} name="myForm" action="/action_page.php"
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="no_of_order" id="no_of_order" class="form-control" value="no_of_order" required>
